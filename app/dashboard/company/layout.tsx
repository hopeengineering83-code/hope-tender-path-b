  ...
  return (
    <>
      ...
      <nav aria-label="Company workspace" className="mb-5 flex min-w-0 flex-wrap gap-2 rounded-xl border border-slate-200 bg-white p-2 shadow-sm">
        ...
        <Link href="/dashboard/company/profile" className="min-h-10 rounded-lg bg-blue-50 px-3 py-2 text-sm font-semibold text-blue-700 hover:bg-blue-100">Company Profile Editor</Link>

...
export default async function AIReadinessPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* F-05 fix: Replace overflow-hidden + min-w-full table with responsive layout.
          On mobile, table columns (Scope, Severity, Purpose) were clipped.
          Now: overflow-x-auto wrapper for table + hidden on mobile, cards shown instead. */}
      <section className="rounded-2xl border bg-white shadow-sm">
        ...
        {/* Mobile: card layout — all fields visible without horizontal scroll */}

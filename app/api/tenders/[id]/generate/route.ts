...
import { generateTenderDocuments } from "../../../../../lib/engine/generation/generate-elite";
import { promoteBestAvailableReviewedMatchesForGeneration } from "../../../../../lib/engine/matching/best-available-selection";
import { applyActiveUploadedLetterheadToTenderDocuments } from "../../../../../lib/engine/generation/apply-active-letterhead";
import { rateLimit, AI_RATE_LIMIT } from "../../../../../lib/rate-limit";
import { buildSubmissionPlan, buildSubmissionPlanWithDerivedFallback, findExtraGeneratedDocuments, findMissingGeneratedDocuments, generatedDocumentSubmissionKey, hasExplicitSubmissionScope, plannedSubmissionTargetFiles, plannedSubmissionTargetKeys, type SubmissionPlanFile } from "../../../../../lib/engine/plans/submission-plan";
import { getCompanyIngestionReadiness } from "../../../../../lib/company-ingestion-readiness";
import { polishBenchmarkOutput } from "../../../../../lib/engine/generation/benchmark-output-polisher";
import { cleanTenderTitle, cleanClientName, formatRequirementLine } from "../../../../../lib/engine/infrastructure/proposal-labels";
...
import { computeStoredMetadataPatch, listInvalidStoredFields } from "../../../../../lib/engine/metadata/sanitize-stored-metadata";
import { isValidClientName, containsMetadataPlaceholder } from "../../../../../lib/engine/metadata/metadata-validators";
import { repairSourceGrounding } from "../../../../../lib/engine/quality/repair-source-grounding";
import { assertAnalysisReadyForFinalGeneration, detectAnalysisSourceWithApproval } from "../../../../../lib/engine/analysis/analysis-source";

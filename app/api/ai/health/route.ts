...
import { CANONICAL_AI_PROVIDER_CHAIN, CANONICAL_AI_PROVIDER_DISPLAY, CANONICAL_AI_PROVIDER_RANK, CANONICAL_AI_PROVIDER_NOTE, configuredCanonicalProviders, preferredCanonicalProvider } from "../../../../lib/ai-provider-policy";
...
async function restoreProviderHealthBeforeResponse(): Promise<string | null> {
  try {
    ...
    return (result as any).warning ?? null;
  } catch {
  ...
  return NextResponse.json({
    ...
    providers: {
      openai: {
        ...
        label: "OpenAI",
        note: CANONICAL_AI_PROVIDER_NOTE.openai,
      ...
      gemini: {
        ...
        label: "Gemini",
        note: CANONICAL_AI_PROVIDER_NOTE.gemini,
      ...
      deepseek: {
        ...
        label: "DeepSeek",
        note: CANONICAL_AI_PROVIDER_NOTE.deepseek,
      ...
      groq: {
        ...
        label: "Groq",
        note: CANONICAL_AI_PROVIDER_NOTE.groq,
      ...
      openrouter: {
        ...
        label: "OpenRouter",
        note: CANONICAL_AI_PROVIDER_NOTE.openrouter,
      ...
      claude: {
        ...
        note: CANONICAL_AI_PROVIDER_NOTE.anthropic,

...
export async function POST(req: Request) {
  ...
  try {
    ...
    void logAction({
      ...
      entityType: "Company",
      entityId: company.id,
      description: `Cleaned support-document imported records: ${result.expertsDeleted} experts, ${result.projectsDeleted} projects deleted, ${result.ambiguousPreserved.length} ambiguous preserved for manual review`,
      metadata: result,
      requestId,
    }).catch((error) => {

...
async function buildDiagnostics(
  ...
  if (unsupportedReviewedExperts > 0) gaps.push({ severity: "CRITICAL", title: "Expert human reviews are stale", detail: `${unsupportedReviewedExperts} expert record(s) previously reviewed by a human no longer match the current source evidence and must be re-reviewed.` });
  if (unsupportedReviewedProjects > 0) gaps.push({ severity: "CRITICAL", title: "Project human reviews are stale", detail: `${unsupportedReviewedProjects} project record(s) previously reviewed by a human no longer match the current source evidence and must be re-reviewed.` });
  if (unsupportedReviewedLegalRecords > 0) gaps.push({ severity: "CRITICAL", title: "Legal human reviews are stale", detail: `${unsupportedReviewedLegalRecords} legal record(s) previously reviewed by a human no longer match the current source evidence and must be re-reviewed.` });
  if (unsupportedReviewedFinancialRecords > 0) gaps.push({ severity: "CRITICAL", title: "Financial human reviews are stale", detail: `${unsupportedReviewedFinancialRecords} financial record(s) previously reviewed by a human no longer match the current source evidence and must be re-reviewed.` });
  if (unsupportedReviewedComplianceRecords > 0) gaps.push({ severity: "CRITICAL", title: "Compliance human reviews are stale", detail: `${unsupportedReviewedComplianceRecords} compliance record(s) previously reviewed by a human no longer match the current source evidence and must be re-reviewed.` });
  ...
  if (expertStates.length > 0 && reviewedExperts === 0) gaps.push({ severity: "MEDIUM", title: "Experts available for review", detail: `${sourceVerifiedExperts} source-verified and ${expertStates.length - sourceVerifiedExperts} draft/stale expert record(s) await human review for final export.` });
  if (projectStates.length > 0 && reviewedProjects === 0) gaps.push({ severity: "MEDIUM", title: "Projects available for review", detail: `${sourceVerifiedProjects} source-verified and ${projectStates.length - sourceVerifiedProjects} draft/stale project record(s) await human review for final export.` });
  if (legalStates.length > 0 && reviewedLegalRecords === 0) gaps.push({ severity: "MEDIUM", title: "Legal records available for review", detail: `${sourceVerifiedLegalRecords} source-verified and ${legalStates.length - sourceVerifiedLegalRecords} draft/stale legal record(s) await human review for final export.` });
  if (financialStates.length > 0 && reviewedFinancialRecords === 0) gaps.push({ severity: "MEDIUM", title: "Financial records available for review", detail: `${sourceVerifiedFinancialRecords} source-verified and ${financialStates.length - sourceVerifiedFinancialRecords} draft/stale financial record(s) await human review for final export.` });
  if (complianceStates.length > 0 && reviewedComplianceRecords === 0) gaps.push({ severity: "MEDIUM", title: "Compliance records available for review", detail: `${sourceVerifiedComplianceRecords} source-verified and ${complianceStates.length - sourceVerifiedComplianceRecords} draft/stale compliance record(s) await human review for final export.` });

...
export async function GET() {
  ...
  if (!isAIConfigured()) actionItems.push({ severity: "HIGH", message: "ANTHROPIC_API_KEY not set — AI extraction disabled. All records will be REGEX_DRAFT only and cannot be promoted to trusted status." });

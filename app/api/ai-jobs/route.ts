...
const VALID_TYPES: JobType[] = ["PROPOSAL_GENERATION", "AI_REMATCH", "EVALUATOR_SIM", "COPILOT_DEEP_ANALYSIS", "PROFILE_FACT_EXTRACTION"];
const VALID_STATUSES: JobStatus[] = ["QUEUED", "RUNNING", "SUCCEEDED", "FAILED", "CANCELED"];

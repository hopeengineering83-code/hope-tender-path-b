...
- **Next action:** owner review. The remaining known item in the acceptance matrix is criterion 8 ("does not build an empty submission plan when requirements exist"), still recorded as not yet exercised.

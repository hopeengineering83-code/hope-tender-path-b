...
import { requireRole, unauthorizedResponse } from "../auth";
 ...
 *
 * This cannot create jobs and cannot start a manual gate. It may only nudge a
 * durable job type that an already-authorized route persisted first.
 */

import type { DocumentPlanResult, RequirementDraft } from "../infrastructure/types";
import { normalizeSubmissionFileName, requiresGeneratedArtifact } from "../workflow/scope-policy";

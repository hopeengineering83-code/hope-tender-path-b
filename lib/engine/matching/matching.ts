import type { CompanyKnowledgeSnapshot, MatchingResult, RequirementDraft } from "../infrastructure/types";
import { exactSelectionLimit } from "../workflow/scope-policy";
import { deriveRequirementConstraintProfile } from "../compliance/requirement-constraints";

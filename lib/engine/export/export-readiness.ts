...
import { isValidClientName, containsMetadataPlaceholder } from "../metadata/metadata-validators";
import { isExportBlockingConfidence, scanTenderForExplicitDonorRequirement } from "../quality/donor-advisory-confidence";
import {
...
export type ExportReadinessResult = {
  ...
  tenderLevelBlockers?: Array<{ category: string; severity: string; title: string; recommendedAction?: string | null; confidence?: import("../quality/donor-advisory-confidence").DonorAdvisoryConfidence; sourceQuote?: string | null }>;
  advisoryWarnings?: Array<{ category: string; severity: string; title: string; recommendedAction?: string | null; confidence?: import("../quality/donor-advisory-confidence").DonorAdvisoryConfidence; sourceQuote?: string | null }>;
};

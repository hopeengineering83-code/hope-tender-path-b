...
function phasesForSector(primarySector: string): Phase[] {
  ...
  if (/energy|solar|hydropower|substation|transmission|generation|electrification|scada/.test(sector)) return [
    ...
    { phase: "Phase 3: Procurement Package", milestones: "BOQ, equipment specifications, and vendor data requirements issued", responsibleRole: "Power Systems Lead + Procurement Specialist", deliverables: "Tender BOQ; equipment specs; vendor data requirements matrix; environmental management plan", duration: "3 to 5 weeks" },
  ...
  if (/agri|irrigation|wua|command.*area|rural.*develop/.test(sector)) return [
    ...
    { phase: "Phase 3: Tender Documents", milestones: "BOQ, specifications, and O&M manual issued", responsibleRole: "Project Principal", deliverables: "Tender BOQ; technical specifications; O&M manual; WUA governance framework; farmer training outline", duration: "3 to 4 weeks" },
  ...
  if (/mining|mineral.*resource|jorc|tailings|ore.*body|mine.*plan/.test(sector)) return [
    ...
    { phase: "Phase 3: Feasibility Report and Permitting", milestones: "JORC-compliant resource report issued; regulatory submission package prepared", responsibleRole: "Project Principal + Environmental Specialist", deliverables: "Feasibility report; JORC resource statement; BOQ; regulatory submission package; closure cost estimate", duration: "4 to 6 weeks" },
  ...
  if (/port|berth|quay|maritime|dredging|harbour/.test(sector)) return [
    ...
    { phase: "Phase 3: Procurement Package", milestones: "BOQ and equipment specifications (fenders, bollards, crane rails) issued", responsibleRole: "Project Principal", deliverables: "Tender BOQ; equipment specifications; environmental management plan; regulatory submission package", duration: "3 to 5 weeks" },
  ...
  if (/pipeline|oil.*facilit|gas.*facilit|hazop|p&id|refinery|petrochemical/.test(sector)) return [
    ...
    { phase: "Phase 3: Procurement Documents", milestones: "Vendor data requirements matrix and BOQ issued", responsibleRole: "Project Principal + Procurement Specialist", deliverables: "Vendor data requirements matrix; BOQ; technical specifications; regulatory submission package", duration: "3 to 5 weeks" },
  ...
  if (/industrial|manufactur|factory|abattoir|processing.*plant|warehouse.*industrial/i.test(sector)) return [
    ...
    { phase: "Phase 4: Tender Documents", milestones: "BOQ, specifications, and equipment schedule issued", responsibleRole: "Project Principal", deliverables: "Tender package; equipment procurement list; FAT requirements; works programme", duration: "3 to 5 weeks" },
  ...
  if (/high.rise|high_rise|multi.stor|tower.*building|mixed.use.*tower|basement.*podium/i.test(sector)) return [
    { phase: "Phase 1: Feasibility & Concept", milestones: "Structural system selected; vertical transport concept agreed; preliminary BOQ produced", responsibleRole: "Lead Architect + Structural Lead", deliverables: "Massing study; floor-plate efficiency analysis; structural system selection memo; preliminary BOQ", duration: "2 to 4 weeks" },
    ...
    { phase: "Phase 4: Regulatory Approvals & Tender Documents", milestones: "Structural calculations submitted to authority; tender package issued", responsibleRole: "Lead Engineer + QS", deliverables: "Structural calculation package; full tender package (drawings, BOQ, specs); bid evaluation report", duration: "4 to 6 weeks" },
  ...
  if (/hotel|hospitality|resort|lodge|guesthouse|five.star|luxury.*accommodat/i.test(sector)) return [
    { phase: "Phase 1: Concept & Feasibility", milestones: "Development programme agreed; feasibility financial model produced; concept design approved", responsibleRole: "Lead Architect + Project Principal", deliverables: "Feasibility study; development programme (room mix, F&B, BOH); concept design; preliminary BOQ", duration: "2 to 4 weeks" },
    ...
    { phase: "Phase 4: Tender Documents & Procurement", milestones: "Tender package issued; FF&E procurement schedule produced; brand sign-off obtained", responsibleRole: "Lead Architect + QS", deliverables: "Tender package (drawings, BOQ, specs); FF&E procurement schedule; brand-operator sign-off", duration: "3 to 5 weeks" },

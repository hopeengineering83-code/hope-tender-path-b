...
import { detectAnalysisSource } from "../analysis/analysis-source";
import { containsPricingLeakage } from "../pricing/pricing-hygiene";
import { DOCUMENT_PLACEHOLDER_PATTERNS } from "../metadata/tender-metadata-completeness";
...
export type SevenPassWiringContext = {
  ...
  resolvedAnalysisSource?: import("../analysis/analysis-source").AnalysisSource | null;
};

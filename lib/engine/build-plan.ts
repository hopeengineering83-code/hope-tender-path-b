...
export function validateCriticalMetadataEvidenceForBuildPlan(
  ...
  checkField("title", effTitle, tender.titleSourceFileId, tender.titleSourcePage, tender.titleSourceQuote, true, "title");
  checkField("clientName", effClientName, tender.clientNameSourceFileId, tender.clientNameSourcePage, tender.clientNameSourceQuote, true, "clientName");
  checkField("deadline", effDeadline, tender.deadlineSourceFileId, tender.deadlineSourcePage, tender.deadlineSourceQuote, true, "deadline");
  checkField("submissionMethod", effMethod, tender.submissionMethodSourceFileId, tender.submissionMethodSourcePage, tender.submissionMethodSourceQuote, true, "submissionMethod");

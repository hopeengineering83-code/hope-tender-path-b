...
export const CANONICAL_FIELD_STATUS_BADGE: Record<CanonicalFieldStatus, { label: string; classes: string }> = {
  ...
  NOT_FOUND_CONFIRMED:                   { label: "Confirmed — final evidence pending",  classes: "bg-amber-100 text-amber-800" },
  MANUAL_CONFIRMED:                      { label: "Confirmed — final evidence pending",  classes: "bg-amber-100 text-amber-800" },

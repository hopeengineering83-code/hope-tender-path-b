...
Do not add broad baselines for legacy metadata terminology. Static audits should be precise enough to allow internal schema names while failing public labels, route responses, and workflow copy that expose metadata as a product concept.

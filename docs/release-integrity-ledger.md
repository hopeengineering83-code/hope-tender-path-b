...
| RI-010 | P1 | Canonical AI provider order is Z.ai GLM → Cerebras → Mistral → Groq → OpenRouter → Gemini → OpenAI → Together → DeepSeek → Anthropic / Claude. | `lib/ai-provider-policy.ts`; provider-policy tests; release audit |

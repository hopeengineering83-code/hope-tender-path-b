...
| RI-010 | P1 | Canonical AI provider order is Mistral → Groq → OpenRouter → Gemini → OpenAI → Together → DeepSeek → Claude/Anthropic. | `lib/ai-provider-policy.ts`; provider-policy tests; release audit |
